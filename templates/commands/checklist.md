...
2. **Load context**: Read upstream artifacts (SPEC_FILE, DESIGN_FILE, PLAN_FILE, IMPLEMENTATION_ARTIFACTS), and `.arc/memory/constitution.md`. Load CHECKLIST_FILE template.
