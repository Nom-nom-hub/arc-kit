...
```text
arc-kit/
├── src/                    # Arc Kit CLI implementation
├── scripts/               # Bash and PowerShell automation scripts
├── templates/             # Adaptive template files
│   └── commands/          # Command templates with adaptive reasoning
├── docs/                  # Documentation
├── ARC-METHODOLOGY.md     # Detailed methodology explanation
├── LICENSE                # MIT License
├── README.md              # This file
...
- [ARC Methodology Guide](ARC-METHODOLOGY.md) - Complete methodology explanation
