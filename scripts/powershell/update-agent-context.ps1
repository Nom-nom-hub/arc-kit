...
if (-not $AgentType) {
    Write-Error "Error: Agent type is required"
    exit 1
}

# Define agent-specific file paths
switch ($AgentType) {
    "claude" { $agentFile = ".claude/commands/arckit-rules.md" }
    "gemini" { $agentFile = ".gemini/commands/arckit-rules.md" }
    "copilot" { $agentFile = ".github/agents/arckit-agent.md" }
    "cursor-agent" { $agentFile = ".cursor/commands/arckit-rules.md" }
    "qwen" { $agentFile = ".qwen/commands/arckit-rules.md" }
    "opencode" { $agentFile = ".opencode/commands/arckit-rules.md" }
    "codex" { $agentFile = ".codex/commands/arckit-rules.md" }
    "windsurf" { $agentFile = ".windsurf/rules/arckit-rules.md" }
    "kilocode" { $agentFile = ".kilocode/rules/arckit-rules.md" }
    "auggie" { $agentFile = ".augment/rules/arckit-rules.md" }
    "codebuddy" { $agentFile = ".codebuddy/commands/arckit-rules.md" }
    "roo" { $agentFile = ".roo/rules/arckit-rules.md" }
    "q" { $agentFile = ".amazonq/prompts/arckit-prompts.md" }
    "amp" { $agentFile = ".agents/commands/arckit-rules.md" }
    "shai" { $agentFile = ".shai/commands/arckit-rules.md" }
    default {
        Write-Error "Error: Unknown agent type: $AgentType"
        exit 1
    }
}
...
Write-Output "Updated agent context file: $agentFile"